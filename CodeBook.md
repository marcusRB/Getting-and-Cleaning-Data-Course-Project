...
These efforts resulted into a clean and tidy dataset - please see [tidy_data.txt](https://github.com/marcusRB/Getting-and-Cleaning-Data-Course-Project/blob/master/tidy_data.txt) and  [tidy_data.csv](https://github.com/marcusRB/Getting-and-Cleaning-Data-Course-Project/blob/master/tidy_data.csv).
...
The transformations are achieved by the script called [run_analysis.R](https://github.com/marcusRB/Getting-and-Cleaning-Data-Course-Project/blob/master/run_analysis.R), which:
...
8. Saves the tidy dataset as [tidy_data.txt](https://github.com/marcusRB/Getting-and-Cleaning-Data-Course-Project/blob/master/tidy_data.txt) and [tidy_data.csv](https://github.com/marcusRB/Getting-and-Cleaning-Data-Course-Project/blob/master/tidy_data.csv) so that it can be easily imported and viewed
